...
class GrandTotalBanner extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Selector<HistoryPageProvider, (YearStats?, MonthStats?, int)>(
      selector: (_, provider) =>
          (provider.yearStats, provider.monthStats, provider.totalDays),
                      ...
                      CustomActionPopupMenu(
                        ...
                        items: const [
                          ...
                          PopupActionItem(
                            ...
                            color: AppColor
                                .creditAccent, // Or any color you prefer
                          ),
                        ],
            ...
            children: [
              HistoryStatItem(
                ...
                extraWidget: HistoryQuickStatCard(
                  ...
                  label: 'Avg = ',
                  value: (monthStats.saving / totalDays).toStringAsFixed(0),
                  color: Colors.greenAccent,
                ),
                color: Colors.greenAccent,
                onTap: () {
              ...
              HistoryStatItem(
                ...
                extraWidget: HistoryQuickStatCard(
                  icon: Icons.trending_up,
                  label: 'Avg = ',
                  value: (monthStats.luxury / totalDays).toStringAsFixed(0),
              ...
              HistoryStatItem(
                ...
                extraWidget: HistoryQuickStatCard(
                  icon: Icons.trending_up,
                  label: 'Avg = ',
                  value: (monthStats.needed / totalDays).toStringAsFixed(0),
