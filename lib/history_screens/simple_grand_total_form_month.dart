...
class _SimpleMonthSummaryBannerState
    extends State<SimpleMonthSummaryBanner>
...
class _ExpandedSummary extends StatelessWidget {
  ...
  const _ExpandedSummary({
    ...
    required this.isCompact, required this.monthKey,
  });
  ...
  Widget build(BuildContext context) {
    ...
    final savingTotal =
    provider.getMonthTotalForType(ExpenseType.saving);
    final luxuryTotal =
    provider.getMonthTotalForType(ExpenseType.luxury);
    final neededTotal =
    provider.getMonthTotalForType(ExpenseType.needed);
